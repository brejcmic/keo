...
%------------------------------------------------------------------------------
\section{\texorpdfstring{Prezentace studentských prací - 3. hodina}{Prezentace studentskych praci - 3. hodina}}
%------------------------------------------------------------------------------
\begin{frame}
...
%------------------------------------------------------------------------------
	\begin{frame}
    \frametitle{Ukázka prezentace - Josef Burda}
		
		\includegraphics[page=1,width=\textwidth]{pdf/KEO-Josef_Burda-Prezentace.pdf}
...
%------------------------------------------------------------------------------
    ...
    \frametitle{Ukázka prezentace - Josef Burda}
		...
		\includegraphics[page=2,width=\textwidth]{pdf/KEO-Josef_Burda-Prezentace.pdf}
...
%------------------------------------------------------------------------------
    ...
    \frametitle{Ukázka prezentace - Josef Burda}
		...
		\includegraphics[page=3,width=\textwidth]{pdf/KEO-Josef_Burda-Prezentace.pdf}
...
%------------------------------------------------------------------------------
    ...
    \frametitle{Ukázka prezentace - Josef Burda}
		...
		\includegraphics[page=4,width=\textwidth]{pdf/KEO-Josef_Burda-Prezentace.pdf}
...
%------------------------------------------------------------------------------
	\begin{frame}
    \frametitle{Textová část závěrečné práce dle Jan Fiala}
		
		\begin{center}
			\includegraphics[page=1,width=6cm]{pdf/KEO-Jan_Fiala-ZP.pdf}
		\end{center}
	
	\end{frame}
%------------------------------------------------------------------------------
	\begin{frame}
    \frametitle{Klasické provedení dle Iveta Kropáčková}
