...
<Properties>
  <View=-443,-47,1350,783,1.5678,467,0>
  <Grid=10,10,1>
  <DataSet=tr_simulace_Zodd.dat>
  <DataDisplay=tr_simulace_Zodd.dpl>
  <OpenDisplay=0>
  <Script=tr_simulace_Zodd.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Název>
...
<Components>
  ...
  <Vpulse V2 1 190 500 -64 -26 0 3 "-5 V" 1 "5 V" 1 "10 ns" 1 "4000 ns" 0 "2 ns" 1 "2 ns" 0>
...
<Diagrams>
  <Rect 100 232 638 232 3 #c0c0c0 1 00 1 0 5e-09 5e-08 1 -3.13402 2 3.13402 1 -1 0.5 1 315 0 225 1 0 0 "time" "" "">
