...
<Properties>
  <View=-381,-170,1313,764,0.940043,0,0>
  <Grid=10,10,1>
  <DataSet=tr_simulace_crosstalk_diff.dat>
  <DataDisplay=tr_simulace_crosstalk_diff.dpl>
  <OpenDisplay=0>
  <Script=tr_simulace_crosstalk_diff.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Název>
...
<Components>
  ...
  <Vpulse V2 1 190 500 -58 -26 1 1 "5 V" 1 "0 V" 1 "5 ns" 1 "4000 ns" 0 "2 ns" 1 "2 ns" 0>
</Components>
<Wires>
